              ...
              <div class="row">
                <div class="col-md-5">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <div class="form-check ml-2">
                      ...
                      />
                      <label class="form-check-label" for="countDuplicates">
                        Count duplicates
                      </label>
                    </div>
                    <div class="form-check ml-2">
                  ...
                  <fieldset class="form-group mb-3">
                    ...
                    <div class="form-check">
                      ...
                      />
                      <label class="form-check-label" for="progressBarIncreasing">
                        Increasing
                      </label>
                    </div>
                  </fieldset>
                ...
                <div class="col-md-4 mb-2">
                  <div class="form-group mb-3">
                    ...
                    />
                    <small id="toastTimeoutHelp" class="form-text text-muted"
                  ...
                  <div class="form-group mb-3">
                    ...
                    />
                    <small id="maxNumberToastsHelp" class="form-text text-muted"
                      >0 is no limit</small
                    >
                    <div class="form-check">
                      <input
                    ...
                    <div class="col-6 col-md-12">
                      <fieldset class="form-group mb-3">
                        ...
                        <div class="form-check">
                          ...
                          />
                          <label for="toast-bottom-right" class="form-check-label"
                            >Bottom Right</label
                          >
                        </div>
                        <div class="form-check">
                          ...
                          />
                          <label for="toast-bottom-left" class="form-check-label"
                            >Bottom Left</label
                          >
                        </div>
                        <div class="form-check">
                        ...
                        <div class="form-check">
                          <input
                            ...
                            id="top-full-width"
                          />
                          <label for="top-full-width" class="form-check-label"
                            >Top Full Width</label
                          >
                        </div>
                        <div class="form-check">
                          <input
